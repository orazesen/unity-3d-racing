...
public class controller : MonoBehaviour
{
    ...
    private float radius = 6, breakPower = 0, DownForceValue = 10f,wheelsRPM ,driftFactor, lastValue ,horizontal , vertical,totalPower;
    ...
    private void Update() {
        ...
        if (hasFinished)
        {
            rigidbody.velocity = rigidbody.velocity / 5;
            return;
        }
    ...
    private void LateUpdate()
    {
        ...
        newPos.y = miniMapObj.position.y;
        miniMapObj.position = newPos;

        miniMapObj.rotation = Quaternion.Euler(90f, transform.eulerAngles.y, 0f);
    }
    ...
    private void getObjects(){
        ...
        if (miniMapObj == null)
        {
            miniMapObj = manager.minimapObjects.GetChild(0);
            ...
            Debug.Log(miniMapObj.transform.position);
        }
    }
